...
# MICA T1w/T2
#
# This script will register a Quantitative Image to T1nativepro space and then to Hippunfold surfaces
#
# Outputs will be store under anat/surfaces/morphology
#
...
\t\033[38;5;197m-qMRI\033[0m 	    : Quantitative MRI image
\t\033[38;5;197m-qMRI_reg\033[0m 	    : Quantitative MRI image to register to T1native
